...
<div class="row">
	<div class="col-md-12">
		...
		<div class="nav-tabs-custom margin">
			...
			{!! Form::model($adminUserRole, array('files' => true, 'id' => 'editAdminUserRoleForm', 'class' => 'panel-body form-horizontal')) !!}
					...
					<div class="tab-pane active" id="tab1">
						<div class="box-body">
							...
							<div class="form-group">
								...
								<div class="col-lg-8">
									<div>
										{!! Form::select('adminUserPermissionIds[]', $adminUserPermissions, $selectedAdminUserPermissions, array('class' => 'form-control select2', 'multiple')) !!}
									</div>
							...
							<div class="form-group">
								...
								<div class="col-lg-8">
									<div class="checkbox">
										{!! Form::checkbox('enabled', null, $adminUserRole->enabled ,array('class' => 'minimal-red')) !!}
									</div>
								</div>
							</div>	
						</div>
