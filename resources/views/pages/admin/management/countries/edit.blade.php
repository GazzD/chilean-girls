...
<div class="row">
	<div class="col-md-12">
		...
		<div class="nav-tabs-custom margin">
			...
			{!! Form::model($country, array('files' => true, 'id' => 'editCountryForm', 'class' => 'panel-body form-horizontal')) !!}
					...
					<div class="tab-pane active" id="tab1">
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-lg-8">
									{!! Form::text('isoCode', $country->isoCode, array('class' => 'form-control', 'id' => 'isoCode', 'maxlength' => '2')) !!}
							...
							<div class="form-group">
								...
								<div class="col-lg-8">
									<div class="checkbox">
										{!! Form::checkbox('enabled', null, $country->enabled ,array('class' => 'minimal-red')) !!}
									</div>	
								</div>
							</div>
						</div>
						...
						<div class="tab-pane" id="tab{{ $i+2 }}">
							<div class="box-body">
								<div class="form-group">
									...
									<div class="col-lg-8">
										{!! Form::text('data['.$language->isoCode.'][name]', $country->{'name:'.$language->isoCode}, array('id' => 'data['.$language->isoCode.'][name]', 'class' => 'form-control')) !!}
