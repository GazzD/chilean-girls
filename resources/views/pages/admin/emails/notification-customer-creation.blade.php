...
<table width="600" cellspacing="0" cellpadding="0" bgcolor="#fff" align="center">
		<thead>
			<tr>
				<div align="center">
					<img style="margin-left:auto; margin-right:auto" src="{{asset('admin/images/Logo-MedProzone-M.png')}}" alt="Medprozone">
				</div>
		...
		<tbody>
			<tr>
				<td style= "padding: 50px 80px; font-family: Arial, Helvetica, sans-serif; color: #000000;">
					<h2 style="font-style: italic">Hello {{ $customer->firstName }}</h2>
