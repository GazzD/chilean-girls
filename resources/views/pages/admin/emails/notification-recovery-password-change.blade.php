...
<table width="600" cellspacing="0" cellpadding="0" bgcolor="#fff" align="center">
		<thead>
			...
			<tr>
				<div align="center">
					<img style="margin-left:auto; margin-right:auto"; src="{!!asset('frontend/images/Logo-MedProzone-M.png')!!}" alt="Medprozone"></a>
				</div>
			...
			<tr>
				<td style= "padding: 50px 80px; font-family: Arial, Helvetica, sans-serif; color: #000000;">
					...
					<p style="font-size: 12px; margin: 10px 0 50px 0;">
						We received a request to reset the password for your account. If you requested a reset, click <a href="{{route('password-recovery/change-password', $code)}}">here</a>. If you didn’t make this request, please ignore this email.	
					</p>
				</td>
			</tr>
		</tbody>
		<tfoot>
			<tr>
				<td style="background-color: #FFFFFF; height: 25px; border-bottom: 5px solid #FF0000; font-family: Arial, Helvetica, sans-serif; font-size: 10px; color: #666666; text-align: center;">
					<span><b>&copy;  {{ trans('frontend/pages/emails.all-rights-reserved') }}</b></span>
				</td>
			</tr>
		</tfoot>
	</table>
