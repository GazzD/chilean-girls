@extends('templates.admin.master.index') @section('title', 'Admin Users')
@section('content')
<div class="row">
	<div class="col-md-12">
		<!-- Body -->
				...
				<div class="tab-content">
					<div class="tab-pane active" id="tab1">
						<div class="box-body">
							...
							<div class="form-group">
								{!! Form::label(null, 'Correo electr&oacute;nico', array('class'=>'col-lg-2 col-sm-2 control-label')) !!} 
								<div class="col-lg-8">
								 	{!! Form::text('email', null, array('class'=>'form-control', 'id' => 'email', 'disabled')) !!}
								</div>
							</div>
							<div class="form-group">
								{!! Form::label(null, 'Tel&eacute;fono', array('class'=>'col-lg-2 col-sm-2 control-label')) !!} 
								<div class="col-lg-8">
								 	{!! Form::text('phone', null, array('class'=>'form-control', 'id' => 'phone', 'disabled')) !!}
								</div>
							</div>
							<div class="form-group">
								{!! Form::label(null, 'Rol', array('class'=>'col-lg-2 col-sm-2 control-label')) !!} 
								<div class="col-lg-8">
							 	{!! Form::text('adminUserRole', $adminUser->adminUserRole->name, array('class'=>'form-control', 'id' => 'role', 'disabled')) !!}
								</div>
							</div>
							<div class="form-group">
								{!! Form::label(null, 'Habilidado', array('class'=>'col-lg-2 col-sm-2 control-label')) !!} 
								<div class="col-lg-8">
									<div class="checkbox">
