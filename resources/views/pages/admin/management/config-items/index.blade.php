					...
					<table id="config-item-table" class="table table-bordered table-striped">
						<thead>
							<tr>
								...
								<th>Key</th>
								<th>Value</th>
								@if(App\Auth::hasAnyPermissions('management/config-items/detail,management/config-items/edit'))
									<th class="text-center btn-group-{{App\Auth::countPermissions('management/config-items/detail,management/config-items/edit')}}">Actions</th>
								@endif
							</tr>
						</thead>
						<tbody>
							...
							<tr>
								...
								<td class="text-center" style="display:{{App\Auth::hasAnyPermissions('management/config-items/detail,management/config-items/edit')?'':'none'}}">
									<div class="btn-group">
										@if(App\Auth::hasPermission('management/config-items/detail'))
											<a href="{{route('management/config-items/detail', $configItem->id)}}" class="btn btn-sm btn-success" title="View">
												<i class="fa fa-file"></i>
											</a>
										@endif
										@if(App\Auth::hasPermission('management/config-items/edit'))
