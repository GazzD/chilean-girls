...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="nav-tabs-custom margin">
            ...
            {!! Form::model($carouselItem, array('files' => true, 'id' => 'addCarouselItemForm', 'class' => 'panel-body form-horizontal')) !!}
                    ...
                    <div class="tab-pane active" id="tab1">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <div>
                                        {!! Form::select('target', $targetTypes, null ,array('class' => 'form-control select2', 'placeholder' => 'Selecciona una opci&oacute;n', 'style' => 'width:100% !important;')) !!}
                                    </div>
