...
<div class="row">
	<div class="col-md-12">
		...
		<div class="nav-tabs-custom margin">
			...
			{!! Form::model($customerAddress, array('id' => 'addCustomerAddressForm', 'class' => 'panel-body form-horizontal')) !!}
					...
					<div class="tab-pane active" id="tab1">
						<div class="box-body">
							...
							<div class="form-group">
								...
								<div class="col-lg-8">
									<div>
										{!! Form::select('state', $states, null, array('class' => 'form-control select2', 'placeholder' => 'Select one option')) !!}
									</div>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-lg-8">
									{!! Form::text('country', $customer->country->name, array('class' => 'form-control', 'disabled')) !!}
								</div>
							</div>
							<div class="form-group">
					...
					<div class="box-body">
						<div class="form-group">
							<div class="col-lg-8 col-lg-offset-2">
								...
								<a href="{{ route('management/customers/addresses', $customerId) }}" class="btn btn-default">Cancel</a>
							</div>
						</div>
					</div>
				</div>
